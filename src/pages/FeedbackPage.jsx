  ...
  try {
    ...
    const prompt = `
      ...
      ${userData ?
        ...
        1. 첫 번째 문단은 반드시 사용자의 식단 평가를 '이번 식사는 [나쁩니다./좋아요./괜찮습니다].' 형식으로 출력합니다.
        [나쁩니다./좋아요./괜찮아요.] 은 사용자의 신체정보와 현재의 삭단을 저속노화를 기준으로 엄격하지 않고 느슨하게 평가해 선택합니다.
        하루 중 한 끼 식사라고 가정 후 평가합니다.
