  ...
  try {
    ...
    const prompt = `
      ...
      ${userData ?
        ...
        다음 지시사항을 반드시 지켜주세요.:
        1. 사용자의 식단 평가를 처음 시작 말을 '[나쁨/좋음/보통].' 형식으로 출력해주세요. [나쁨/좋음/보통] 은 사용자의 신체정보와 현재 누적된 영양성분을 배경으로 구체적인 영향학적 기준으로 실행합니다.
        2. 개선사항의 경우, 저속노화를 위해 다음 식사에는 어떤 영양분이 부족하고 필요한지 명시해주세요.
        3. 무엇이 부족하고 다음에는 뭘 추천하는지 간략하게 30자 이내로 작성하세요.
        4. 답변에 '**'와 같은 굵은 글씨 표시는 사용하지 마세요.
        `;
